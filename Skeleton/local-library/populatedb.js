...
console.log(
  'This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: node populatedb "mongodb+srv://katsuoo:eO5mkrRQshRGRorQ@cluster0.owfbadb.mongodb.net/local_library?retryWrites=true&w=majority"'
);
